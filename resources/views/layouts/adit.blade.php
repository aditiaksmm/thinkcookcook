...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>VELOSOFY STORE</b></h1>
    <h6>Welcome to the store of <span class="w3-tag">Velosofy's world</span></h6>
  </header>
  ...
  <header class="w3-display-container w3-wide" id="home">
    ...
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-white">Velosofy's</h1>
      <h1 class="w3-jumbo w3-text-white w3-hide-small"><b>WELCOME</b></h1>
